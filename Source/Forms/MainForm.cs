...
namespace AutomaticReplayViewer
{
    public partial class MainForm : Form
    {
        ...
        private static void GenerateConfigFile()
        {
            ...
            sb.AppendLine("    <add key=\"ROAMenuState\" value=\"0x232F908\" />");
            sb.AppendLine("    <add key=\"ROACursorX\" value=\"0x0232F8E0,0x80,0xA0\" />");
            sb.AppendLine("    <add key=\"ROACursorY\" value=\"0x0232F8E0,0x80,0xA4\" />");
            ...
            sb.AppendLine("    <add key=\"LastTimePointersUpdated\" value=\"1/9/19\" />");
            sb.AppendLine("  </appSettings>");
            sb.AppendLine("</configuration>");
