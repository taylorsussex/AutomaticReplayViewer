...
namespace AutomaticReplayViewer
{
    public partial class MainForm : Form
    {
        ...
        private static void GenerateConfigFile()
        {
            ...
            sb.AppendLine("    <add key=\"ROAMenuState\" value=\"0x2343AB0\" />");
            sb.AppendLine("    <add key=\"ROACursorX\" value=\"0x02343A88,0x80,0xA0\" />");
            sb.AppendLine("    <add key=\"ROACursorY\" value=\"0x02343A88,0x80,0xA4\" />");
            ...
            sb.AppendLine("    <add key=\"LastTimePointersUpdated\" value=\"9/10/19\" />");
            sb.AppendLine("  </appSettings>");
            sb.AppendLine("</configuration>");
