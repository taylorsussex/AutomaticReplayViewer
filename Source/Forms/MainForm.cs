...
namespace AutomaticReplayViewer
{
    public partial class MainForm : Form
    {
        ...
        private static void GenerateConfigFile()
        {
            ...
            sb.AppendLine("    <add key=\"SGMenuState\" value=\"4028396\" />");
            ...
            sb.AppendLine("    <add key=\"ROAMenuState\" value=\"0x4CE0040\" />");
            sb.AppendLine("    <add key=\"ROACursorX\" value=\"0x04CE0018,0x80,0xA0\" />");
            sb.AppendLine("    <add key=\"ROACursorY\" value=\"0x04CE0018,0x80,0xA4\" />");
            ...
            sb.AppendLine("    <add key=\"LastTimePointersUpdated\" value=\"30/11/20\" />");
            sb.AppendLine("  </appSettings>");
            sb.AppendLine("</configuration>");
