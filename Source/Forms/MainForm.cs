...
namespace AutomaticReplayViewer
{
    public partial class MainForm : Form
    {
        ...
        private static void GenerateConfigFile()
        {
            ...
            sb.AppendLine("    <add key=\"ROAMenuState\" value=\"0x22E1090\" />");
            sb.AppendLine("    <add key=\"ROACursorX\" value=\"0x022E1068,0x80,0xA0\" />");
            sb.AppendLine("    <add key=\"ROACursorY\" value=\"0x022E1068,0x80,0xA4\" />");
            ...
            sb.AppendLine("    <add key=\"LastTimePointersUpdated\" value=\"3/6/19\" />");
            sb.AppendLine("  </appSettings>");
            sb.AppendLine("</configuration>");
