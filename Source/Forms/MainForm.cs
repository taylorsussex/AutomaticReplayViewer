...
namespace AutomaticReplayViewer
{
    public partial class MainForm : Form
    {
        ...
        private static void GenerateConfigFile()
        {
            ...
            sb.AppendLine("    <add key=\"ROAMenuState\" value=\"0x4DF75B8\" />");
            sb.AppendLine("    <add key=\"ROACursorX\" value=\"0x4DF7590,0x80,0xA0\" />");
            sb.AppendLine("    <add key=\"ROACursorY\" value=\"0x4DF7590,0x80,0xA4\" />");
            ...
            sb.AppendLine("    <add key=\"LastTimePointersUpdated\" value=\"20/02/22\" />");
            sb.AppendLine("  </appSettings>");
            sb.AppendLine("</configuration>");
