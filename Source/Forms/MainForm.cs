...
namespace AutomaticReplayViewer
{
    public partial class MainForm : Form
    {
        ...
        private static void GenerateConfigFile()
        {
            ...
            sb.AppendLine("    <add key=\"ROAMenuState\" value=\"0x22328B0\" />");
            sb.AppendLine("    <add key=\"ROACursorX\" value=\"0x02232918,0xE4,0x80,0xA0\" />");
            sb.AppendLine("    <add key=\"ROACursorY\" value=\"0x02232918,0xE4,0x80,0xA4\" />");
            ...
            sb.AppendLine("    <add key=\"LastTimePointersUpdated\" value=\"29/12/18\" />");
            sb.AppendLine("  </appSettings>");
            sb.AppendLine("</configuration>");
